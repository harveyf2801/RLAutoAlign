...
class FilterVisualisation:
    """A filter response visualisation using matplotlib made to render OpenAI gym environments"""
...
if __name__ == '__main__':
    ...
    FilterVisualisation(title = "Filter Response",
                        show_phase=True,
